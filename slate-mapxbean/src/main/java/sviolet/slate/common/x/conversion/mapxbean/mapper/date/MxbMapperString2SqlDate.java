...
public class MxbMapperString2SqlDate extends MxbMapperString2UtilDate {
     ...
     */
    public MxbMapperString2SqlDate(String timeZone) {
        super(timeZone);
    }

    @Override
    public Object map(Object from, Class<?> toType, Type toGenericType, Cause cause) throws Exception {
        return new java.sql.Date(((java.util.Date)super.map(from, toType, toGenericType, cause)).getTime());
    }
